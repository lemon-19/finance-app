      ...
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-8 sm:p-10 flex flex-col gap-6">
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 533.5 544.3">
            <path
              fill="#4285F4"
              d="M533.5 278.4c0-17.4-1.6-34.1-4.6-50.4H272v95.4h147c-6.4 34.5-25.8 63.7-55 83.2v68h88.9c52.2-48 82.6-118.7 82.6-196.2z"
            />
            <path
              fill="#34A853"
              d="M272 544.3c74.2 0 136.5-24.7 182-66.7l-88.9-68c-24.7 16.6-56.1 26.3-93.1 26.3-71.6 0-132.2-48.3-153.8-113.1H27v70.7C72.1 485.1 167 544.3 272 544.3z"
            />
            <path
              fill="#FBBC05"
              d="M118.2 325.5c-5.4-16.2-8.5-33.6-8.5-51.5s3.1-35.3 8.5-51.5V152.3H27C9.6 187.5 0 223.8 0 261s9.6 73.5 27 108.7l91.2-44.2z"
            />
            <path
              fill="#EA4335"
              d="M272 107.4c38.7 0 73.2 13.3 100.5 39.3l75.3-75.3C408.4 24.8 346.1 0 272 0 167 0 72.1 59.2 27 152.3l91.2 70.7c21.6-64.8 82.2-113.1 153.8-113.1z"
            />
          </svg>
          Sign in with Google
        </button>
